...
class RoIDataLayer(object):
  ...
  def _get_next_minibatch(self, rgba=False):
    ...
    return get_minibatch(minibatch_db, self._num_classes, rgba=rgba)
      
  def forward(self, rgba=False):
    """Get blobs and copy them into this layer's top blob vector."""
    blobs = self._get_next_minibatch(rgba)
    return blobs
