...
def parse_args():
  ...
  parser.add_argument('--models', dest='models',
            help='folder with models to test',
...
if __name__ == '__main__':
  ...
  models = glob.glob(args.models + "/*.pth")
  models.sort()
  ...
  for model in models:
      ...
      map, f1 = test_net(net, imdb, filename, max_per_image=args.max_per_image)

      print(iters, map, f1)

      results.append((iters, map, f1))
