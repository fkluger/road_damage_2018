...
if __name__ == '__main__':
    ...
    image_channels = 4 if 'rgba' in args.imdb_name else 3
    ...
    if args.net == 'vgg16':
        ...
        net = resnetv1(num_layers=50, image_channels=image_channels)
    elif args.net == 'res101':
        net = resnetv1(num_layers=101, image_channels=image_channels)
    elif args.net == 'res152':
        net = resnetv1(num_layers=152, image_channels=image_channels)
    ...
    train_net(net, imdb, roidb, valroidb, output_dir, tb_dir,
            ...
            max_iters=args.max_iters, image_channels=image_channels)
